          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="fade-in">
              <p className="text-lg leading-relaxed text-foreground/90 mb-6">
                I'm a Full Stack and AI Engineer focused on building production-ready applications that combine modern web technologies with AI. My work includes developing scalable backend services, data ingestion pipelines, REST APIs, and AI-powered workflows that transform raw data into intelligent user experiences.


              </p>
              
              <p className="text-lg leading-relaxed text-foreground/90 mb-8">
                I'm particularly interested in AI infrastructure, Retrieval-Augmented Generation (RAG), vector search, distributed systems, and backend architecture. I enjoy designing end-to-end systems that are scalable, maintainable, and built for real-world production environments.
              </p>
